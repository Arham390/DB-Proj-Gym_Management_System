...
{
    public partial class WorkoutPlanTrainer : Form
    {
        private string ConnectionString = GlobalSettings.GetConnectionString();
        private int userID;
        public WorkoutPlanTrainer(int userID)
        {
            InitializeComponent();
            this.userID = userID;
        }
        ...
        {
            // Load data into the WorkoutPlans table
            this.workoutPlansTableAdapter.Fill(this.projectDataSet.WorkoutPlans);

            // You can further customize the appearance and populate the form here
        }
        ...
        {
            TrainerInterface memberInterfaceForm = new TrainerInterface(userID);
            memberInterfaceForm.Show();
            this.Hide();
        }
